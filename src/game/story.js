...
export const ACHIEVEMENTS = [
  { id: "first_start", title: "New Arrival", desc: "Start your first career in Cape Marlow.", icon: "🧳" },
  { id: "first_entry", title: "Paid Your Dues", desc: "Pay your first event entry fee and grid up.", icon: "🎫" },
  { id: "first_win", title: "Beat the Clock", desc: "Beat the target time in an autocross event.", icon: "🏆" },
  { id: "clean_win", title: "Cone Free", desc: "Win an event without hitting a single cone.", icon: "✨" },
  { id: "rep_20", title: "On the Board", desc: "Reach 20 points in a single season.", icon: "📋" },
  { id: "stage1_complete", title: "Fully Built", desc: "Unlock every Stage 1 mod.", icon: "🔧" },
